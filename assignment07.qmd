...
The average RMSE for the linear regression model is approximately 2.1, the *KNN* model with hyperparameter tuning for the number of neighbors is approximately 2.5, and the random forest model has a RMSE of approximately 1.9.

## 4. Calculating Out-of-Sample Error

The random forest model has both the lowest averaged mean absolute error and the lowest average root mean square error. The out-of-sample error rate is the RMSE of the tested model is approximately 1.9.
