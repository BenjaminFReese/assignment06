...
Adding up all of the subtractions gives us, $1+0+4+16+1=22$. The final step is to divide by the sample size, for us that is $n=5$. So, $22/5$, or, approximately, $4.4$ is the mean squared error.

$$\hat{MSE}=\frac{22}{5}\approxeq4.4$$
